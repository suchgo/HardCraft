package io.github.suchgo.hardcraft.datagen.custom;
...
public class GemEmpoweringRecipeBuilder implements RecipeBuilder {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public Result(ResourceLocation pId, Item pResult, int pCount, Ingredient ingredient, Advancement.Builder pAdvancement, ResourceLocation pAdvancementId) {
            this.id = pId;
            this.result = pResult;
            this.count = pCount;
        ...
        public @NotNull ResourceLocation getId() {
            return new ResourceLocation(HardCraft.MODID, Objects.requireNonNull(ForgeRegistries.ITEMS.getKey(this.result)).getPath() + "_from_gem_empowering");
        }
