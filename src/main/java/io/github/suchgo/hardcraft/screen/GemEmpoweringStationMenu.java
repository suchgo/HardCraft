...
import io.github.suchgo.hardcraft.init.MenuTypeInit;
...
public class GemEmpoweringStationMenu extends AbstractContainerMenu {
    ...
    public GemEmpoweringStationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MenuTypeInit.GEM_EMPOWERING_MENU.get(), pContainerId);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 134, 53));
        });
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockInit.GEM_EMPOWERING_STATION_BLOCK.get());
    }
